...
def dataloader0(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/content/ganpy/GAN/data/0/', transform=transform)
    dataloader0 = DataLoader(dataset=dataset, batch_size=batch_size, shuffle=False)
    print("from dataloader",dataloader0.shape)
    print("from data",dataloader0)
    return dataloader0
...
def dataloader1(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/content/ganpy/GAN/data/1/', transform=transform)
...
def dataloader2(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/content/ganpy/GAN/data/2/', transform=transform)
...
def dataloader3(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/content/ganpy/GAN/data/3/', transform=transform)
