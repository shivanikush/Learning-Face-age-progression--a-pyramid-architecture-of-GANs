...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=str, default=4, help='The size of batch')
    parser.add_argument('--input_size', type=int, default=224, help='The size of input image')
    parser.add_argument('--save_dir', type=str, default='/content/ganpy1/GAN/Pyramid-GAN/Dict/', help='Directory name to save the model')
    parser.add_argument('--result_dir', type=str, default='/content/ganpy1/GAN/Pyramid-GAN/results', help='Directory name to save the generated images')
